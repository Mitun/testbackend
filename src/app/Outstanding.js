...
const Outstanding = ({}) => {
  ...
  const mycontract = "0x24B477C01F899CccD71e291751fe4B98e60Ac439";
  ...
  async function getbalanceData() {
    try {
      const mydeporesult0 = await contract?.getbalance(address);
      const balanceInDecimal = ethers.utils.formatUnits(mydeporesult0, 18); // Adjust '18' if your token has a different number of decimals
